...
public final class StdDraw implements ActionListener, MouseListener, MouseMotionListener, KeyListener {
    ...
    ************************************************************************
     ...
     * <tt>line()</tt>, <tt>circle()</tt>, and <tt>square()</tt>
     ...
     * of shapes, display on screen for a fixed amount of time, and repeat). It
    ...
    ************************************************************************
     ...
     * control). See
     * <a href = "http://download.oracle.com/javase/6/docs/api/java/awt/event/KeyEvent.html">KeyEvent.java</a>
